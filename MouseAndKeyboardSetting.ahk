...
hotkeys := [
    ...
    {key: "F1 & 4", func: (*) => Send("!{F1}"), desc: "<<Alt+F1>>キーを送信します。"},
    ...
    {key: "F2 & 4", func: (*) => Send("!{F2}"), desc: "<<Alt+F2>>キーを送信します。"},
    {key: "F2 & z", func: (*) => Send("^{F13}"), desc: "<<Ctrl+F13>>キーを送信します。"},
    {key: "F2 & x", func: (*) => Send("^{F14}"), desc: "<<Ctrl+F14>>キーを送信します。"},
    {key: "F2 & c", func: (*) => Send("^{F15}"), desc: "<<Ctrl+F15>>キーを送信します。"},
    {key: "F2 & v", func: (*) => Send("^{F16}"), desc: "<<Ctrl+F16>>キーを送信します。"},
    {key: "F2 & a", func: (*) => Send("^{F17}"), desc: "<<Ctrl+F17>>キーを送信します。"},
    {key: "F2 & s", func: (*) => Send("^{F18}"), desc: "<<Ctrl+F18>>キーを送信します。"},
    {key: "F2 & d", func: (*) => Send("^{F19}"), desc: "<<Ctrl+F19>>キーを送信します。"},
    {key: "F2 & f", func: (*) => Send("^{F20}"), desc: "<<Ctrl+F20>>キーを送信します。"},
    {key: "F2 & q", func: (*) => Send("^{F21}"), desc: "<<Ctrl+F21>>キーを送信します。"},
    {key: "F2 & w", func: (*) => Send("^{F22}"), desc: "<<Ctrl+F22>>キーを送信します。"},
    {key: "F2 & e", func: (*) => Send("^{F23}"), desc: "<<Ctrl+F23>>キーを送信します。"},
    {key: "F2 & r", func: (*) => Send("^{F24}"), desc: "<<Ctrl+F24>>キーを送信します。"},
    {key: "F12 & 1", func: (*) => Send("{F12}"), desc: "<<F12>>キーを送信します。"},
    {key: "F12 & 2", func: (*) => Send("^{F12}"), desc: "<<Ctrl+F12>>キーを送信します。"},
    {key: "F12 & 3", func: (*) => Send("+{F12}"), desc: "<<Shift+F12>>キーを送信します。"},
    {key: "F12 & 4", func: (*) => Send("!{F12}"), desc: "<<Alt+F12>>キーを送信します。"},
    {key: "F12 & z", func: (*) => Send("+{F13}"), desc: "<<Shift+F13>>キーを送信します。"},
    {key: "F12 & x", func: (*) => Send("+{F14}"), desc: "<<Shift+F14>>キーを送信します。"},
    {key: "F12 & c", func: (*) => Send("+{F15}"), desc: "<<Shift+F15>>キーを送信します。"},
    {key: "F12 & v", func: (*) => Send("+{F16}"), desc: "<<Shift+F16>>キーを送信します。"},
    {key: "F12 & a", func: (*) => Send("+{F17}"), desc: "<<Shift+F17>>キーを送信します。"},
    {key: "F12 & s", func: (*) => Send("+{F18}"), desc: "<<Shift+F18>>キーを送信します。"},
    {key: "F12 & d", func: (*) => Send("+{F19}"), desc: "<<Shift+F19>>キーを送信します。"},
    {key: "F12 & f", func: (*) => Send("+{F20}"), desc: "<<Shift+F20>>キーを送信します。"},
    {key: "F12 & q", func: (*) => Send("+{F21}"), desc: "<<Shift+F21>>キーを送信します。"},
    {key: "F12 & w", func: (*) => Send("+{F22}"), desc: "<<Shift+F22>>キーを送信します。"},
    {key: "F12 & e", func: (*) => Send("+{F23}"), desc: "<<Shift+F23>>キーを送信します。"},
    {key: "F12 & r", func: (*) => Send("+{F24}"), desc: "<<Shift+F24>>キーを送信します。"},
    {key: "F11 & 1", func: (*) => Send("{F11}"), desc: "<<F11>>キーを送信します。"},
    {key: "F11 & 2", func: (*) => Send("^{F11}"), desc: "<<Ctrl+F11>>キーを送信します。"},
    {key: "F11 & 3", func: (*) => Send("+{F11}"), desc: "<<Shift+F11>>キーを送信します。"},
    {key: "F11 & 4", func: (*) => Send("!{F11}"), desc: "<<Alt+F11>>キーを送信します。"},
    {key: "F11 & z", func: (*) => Send("!{F13}"), desc: "<<Alt+F13>>キーを送信します。"},
    {key: "F11 & x", func: (*) => Send("!{F14}"), desc: "<<Alt+F14>>キーを送信します。"},
    {key: "F11 & c", func: (*) => Send("!{F15}"), desc: "<<Alt+F15>>キーを送信します。"},
    {key: "F11 & v", func: (*) => Send("!{F16}"), desc: "<<Alt+F16>>キーを送信します。"},
    {key: "F11 & a", func: (*) => Send("!{F17}"), desc: "<<Alt+F17>>キーを送信します。"},
    {key: "F11 & s", func: (*) => Send("!{F18}"), desc: "<<Alt+F18>>キーを送信します。"},
    {key: "F11 & d", func: (*) => Send("!{F19}"), desc: "<<Alt+F19>>キーを送信します。"},
    {key: "F11 & f", func: (*) => Send("!{F20}"), desc: "<<Alt+F20>>キーを送信します。"},
    {key: "F11 & q", func: (*) => Send("!{F21}"), desc: "<<Alt+F21>>キーを送信します。"},
    {key: "F11 & w", func: (*) => Send("!{F22}"), desc: "<<Alt+F22>>キーを送信します。"},
    {key: "F11 & e", func: (*) => Send("!{F23}"), desc: "<<Alt+F23>>キーを送信します。"},
    {key: "F11 & r", func: (*) => Send("!{F24}"), desc: "<<Alt+F24>>キーを送信します。"},
